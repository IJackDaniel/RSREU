...
class Situation:
    ...
    def bfs(self):
        ...
        path = [self.coord]                         # добавление начальной ситуации в массив посещённых ситуаций
        ...
        while available_path:                                           # Пока deque не пуст
            ...
            for move in new_moves:                                       # прохождение по всем новым шагам
                if all(move != x for x in path):                         # если шага не было в очереди
                    available_path.append(move)                          # добавление новой ситуации в путь
                    path.append(move)                                    # добавление шага в массив ситуаций
