...
import ru.rsreu.afonin0517.view.converter.VoucherTableColumn;
...
public final class SmartTableDrawer {
	...
	public static String drawTable(String[] headers, String[][] data) {
		...
		int[] widths = VoucherTableColumn.getAllWidths();
		TableAlignment[] alignments = VoucherTableColumn.getAllAlignments();
