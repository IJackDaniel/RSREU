package ru.rsreu.afonin0817.view.table;

import ru.rsreu.afonin0817.view.converter.TableColumnInterface;
...
public final class SmartTableDrawer {
	...
	public static String drawTable(String[] headers, String[][] data,
			Class<? extends Enum<? extends TableColumnInterface>> columnEnumClass) {

		Enum<? extends TableColumnInterface>[] enumConstants = columnEnumClass.getEnumConstants();
		TableColumnInterface[] columns = (TableColumnInterface[]) enumConstants;

		int[] widths = TableColumnInterface.getAllWidths(columns);
		TableAlignment[] alignments = TableColumnInterface.getAllAlignments(columns);
