...
public final class DataInitializer {
	...
	public static Aircraft[] initializeFleet() {
		return new Aircraft[] {
				...
				new CargoPlane("Ilyushin II-76TD-90A", 4000, new Manufacturer("Ilyushin", "Russia"), 50, 48000),

				new CargoPlane("Boeing 747-8 Freighter", 8200, new Manufacturer("Boeing", "USA"), 68, 140000),
