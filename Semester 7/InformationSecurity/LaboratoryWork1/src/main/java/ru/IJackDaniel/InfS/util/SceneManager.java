...
public class SceneManager {
    ...
    public static void initialize(
        ...
        SceneManager.passwordSettings =
                passwordSettings;

        SceneManager.passwordSecurityCalculator =
    ...
    public static void showGeneratorSettings() {
        try {
            ...
            GeneratorSettingsController controller =
                    loader.getController();
